...
import ru.practicum.server.booking.dto.BookItemRequestDto;
import ru.practicum.server.booking.dto.BookingState;
...
public class BookingController {
	...
	ResponseEntity<Object> approvedBooking(@Valid @RequestParam(value = "approved") Boolean approved,
									   @PathVariable long bookingId,
